...
class LinkPredCliqueTrainer(LinkPredTrainer):
    def __init__(self):
    ...
    def get_optimizer(self) -> torch.optim.Optimizer:
        return NotImplementedError("Clique model does not support getting optimizer.")
    
    def get_criterion(self) -> torch.nn.Module:
        return NotImplementedError("Clique model does not support getting criterion.")
    ...
    def train_for_one_epoch(self, split_mode: str):
        raise NotImplementedError("Clique model does not support training.")

    def early_stopping_checker(self, early_stopper) -> bool:
        raise NotImplementedError("Clique model does not support early stopping.")
    
    def forward_backbone(self, snapshot: torch.Tensor, snapshot_feat: torch.Tensor, node_feat: torch.Tensor) -> torch.Tensor:
        raise NotImplementedError("Clique model does not support forward backbone.")
    ...
    def update_metrics(self, 
                        ...
                        split_mode: str):
        raise NotImplementedError("Clique model does not support updating metrics.")
    ...
    def get_dataset_regex_pattern(self) -> str:
        ...
        raise NotImplementedError("Clique model does not support getting dataset regex pattern.")

    def _get_run_save_dir(self) -> str:
        linkpredtrainer_run_save_dir = super(LinkPredCliqueTrainer, self)._get_run_save_dir()
    ...
    def list_of_metrics_names(self) -> List[str]:
        raise NotImplementedError("Clique model does not support getting list of metrics names.")