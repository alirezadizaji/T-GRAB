...
from ...model.gclstm import MultiLayerGCLSTM, GCLSTMParam
from .trainer import DTDGTrainer

class GCLSTMTrainer(DTDGTrainer):
    ...
    def get_model(self) -> Dict[str, Module]:
        models = super(GCLSTMTrainer, self).get_model()
    ...
    def _get_run_save_dir(self) -> str:
        dtdgtrainer_run_save_dir = super(GCLSTMTrainer, self)._get_run_save_dir()
