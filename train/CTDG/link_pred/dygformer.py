...
from ...CTDG.dygformer import DyGFormerTrainer
from ...CTDG.trainer import NODE_EMB_MODEL_NAME

class LinkPredDyGFormerTrainer(LinkPredTrainer, DyGFormerTrainer):
    def __init__(self):
        super().__init__()
    ...
    def forward_backbone(self, 
        ...
        batch_src_node_embeddings, batch_dst_node_embeddings = \
            self.model[NODE_EMB_MODEL_NAME].compute_src_dst_node_temporal_embeddings(src_node_ids=batch_src.cpu().numpy(),
        ...
        if batch_neg is None:
            ...
            batch_neg_src_node_embeddings, batch_neg_dst_node_embeddings = \
                self.model[NODE_EMB_MODEL_NAME].compute_src_dst_node_temporal_embeddings(src_node_ids=batch_neg[0].cpu().numpy(),
