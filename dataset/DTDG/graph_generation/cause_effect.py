...
class CauseEffectGenerator(GraphGenerator):
    _pattern = r"^\((\d+), (\d+)\)$"
    REGEX = f"{_pattern}"
    ...
    def __init__(self, args) -> None:
        ...
        if re.fullmatch(CauseEffectGenerator._pattern, num_of_gap_and_patterns):
            match = re.fullmatch(CauseEffectGenerator._pattern, num_of_gap_and_patterns)
