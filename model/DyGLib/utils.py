...
def get_neighbor_sampler(src_node_ids, 
                         dst_node_ids, 
                         edge_ids, 
                         node_interact_times, 
    ...
    for src_node_id, dst_node_id, edge_id, node_interact_time in zip(src_node_ids, dst_node_ids, edge_ids, node_interact_times):
